<?php
  ...
  $sql = "INSERT INTO member_info (ID,username,password,email,orig_email,account_opened,last_login,last_transaction) VALUES ('','$username','$crypt_pwd','$email','$email','$date_now','$date_now','$date_now')";
  $result = mysqli_query($conn, $sql);
